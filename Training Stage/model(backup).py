...
def unet(input_size = (256,256,3)):
    ...
    conv1 = Conv2D(64, (3,3), activation = 'relu', kernel_initializer = 'he_normal')(inputs)
    ...
    up6 = Conv2D(512, 2, activation = 'relu', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(drop5))
    ...
    up9 = Conv2D(64, 2, activation = 'relu', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv8))
    ...
    conv9 = Conv2D(2, 3, activation = 'relu', kernel_initializer = 'he_normal')(conv9)
